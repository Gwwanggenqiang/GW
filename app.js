...
app.get("/imagelist",(req,res)=>{
  var obj = [
    ...
    {id:2,img_url:"http://127.0.0.1:3000/img/lb2.jpg"},
    {id:3,img_url:"http://127.0.0.1:3000/img/lb3.jpg"},
    {id:4,img_url:"http://127.0.0.1:3000/img/lb4.jpg"},
    {id:5,img_url:"http://127.0.0.1:3000/img/lb5.jpg"},
    {id:6,img_url:"http://127.0.0.1:3000/img/lb6.jpg"}
    ];
  res.send(obj)
});
...
app.get("/miaList",(req,res)=>{
  var sql='select * from mia_list';
  pool.query(sql,(err,result)=>{
    if(err) throw err
    //console.log(result)
    res.send(result)
...
app.get("/getItem",(req,res)=>{
  ...
  var sql='select * from mia_item where lid=? '
